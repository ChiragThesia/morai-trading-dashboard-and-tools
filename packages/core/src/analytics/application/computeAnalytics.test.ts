...
function workedExampleSmile(underlying: string, expiration: string): SmileQuote[] {
  return [
    { underlying, root: "SPXW" as const, expiration, strike: 5400000, contractType: "P", iv: 0.18, delta: -0.2, moneyness: 0.98 },
    { underlying, root: "SPXW" as const, expiration, strike: 5300000, contractType: "P", iv: 0.22, delta: -0.3, moneyness: 0.96 },
    { underlying, root: "SPXW" as const, expiration, strike: 5600000, contractType: "C", iv: 0.15, delta: 0.3, moneyness: 1.02 },
    { underlying, root: "SPXW" as const, expiration, strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
  ];
}
