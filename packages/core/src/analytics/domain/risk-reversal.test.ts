...
const bracketingSmile: ReadonlyArray<SmileQuote> = [
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5300000, contractType: "P", iv: 0.22, delta: -0.35, moneyness: 0.96 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5400000, contractType: "P", iv: 0.2, delta: -0.2, moneyness: 0.98 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.17, delta: 0.2, moneyness: 1.02 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5700000, contractType: "C", iv: 0.16, delta: 0.35, moneyness: 1.04 },
];

// A one-sided smile: no quote reaches ±0.25 on the put wing → cannot bracket.
const unbracketableSmile: ReadonlyArray<SmileQuote> = [
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.17, delta: 0.1, moneyness: 1.02 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5700000, contractType: "C", iv: 0.16, delta: 0.05, moneyness: 1.04 },
];
...
const workedExampleSmile: ReadonlyArray<SmileQuote> = [
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5400000, contractType: "P", iv: 0.18, delta: -0.2, moneyness: 0.98 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5300000, contractType: "P", iv: 0.22, delta: -0.3, moneyness: 0.96 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.15, delta: 0.3, moneyness: 1.02 },
  { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
];
...
describe("interpolateRiskReversal", () => {
  ...
  it("returns null when a put wing is too shallow to reach −0.25", () => {
    const shallowPuts: ReadonlyArray<SmileQuote> = [
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5500000, contractType: "P", iv: 0.18, delta: -0.18, moneyness: 1.0 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "P", iv: 0.17, delta: -0.1, moneyness: 1.01 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.15, delta: 0.3, moneyness: 1.02 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
    ];
  ...
  it("ignores points with a null delta (filtered before interpolation)", () => {
    const withNullDelta: ReadonlyArray<SmileQuote> = [
      ...workedExampleSmile,
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5500000, contractType: "C", iv: 0.5, delta: null, moneyness: 1.0 },
    ];
  ...
  it("ignores points with a NaN delta or NaN iv (filtered before interpolation)", () => {
    const withNaN: ReadonlyArray<SmileQuote> = [
      ...workedExampleSmile,
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5500000, contractType: "P", iv: Number.NaN, delta: -0.25, moneyness: 1.0 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5510000, contractType: "C", iv: 0.3, delta: Number.NaN, moneyness: 1.0 },
    ];
  ...
  it("drops a non-physical |delta| >= 1 put point that would otherwise deepen the put bracket (WR-04)", () => {
    ...
    const strayDeepensPut: ReadonlyArray<SmileQuote> = [
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5400000, contractType: "P", iv: 0.18, delta: -0.2, moneyness: 0.98 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5100000, contractType: "P", iv: 0.95, delta: -1.4, moneyness: 0.9 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.15, delta: 0.3, moneyness: 1.02 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
    ];
  ...
  it("drops a non-physical |delta| >= 1 call point that would otherwise deepen the call bracket (WR-04)", () => {
    ...
    const strayDeepensCall: ReadonlyArray<SmileQuote> = [
      ...
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5300000, contractType: "P", iv: 0.22, delta: -0.3, moneyness: 0.96 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5900000, contractType: "C", iv: 0.02, delta: 1.3, moneyness: 1.1 },
    ];
  ...
  it("drops a delta == 1 boundary point as non-physical (a real delta is strictly within (-1, 1))", () => {
    ...
    const boundaryDeepensCall: ReadonlyArray<SmileQuote> = [
      ...
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5300000, contractType: "P", iv: 0.22, delta: -0.3, moneyness: 0.96 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5900000, contractType: "C", iv: 0.01, delta: 1, moneyness: 1.1 },
    ];
  ...
  it("becomes unbracketable on a wing whose only spanning point is non-physical → null (WR-04)", () => {
    ...
    const onlyStrayReachesPut: ReadonlyArray<SmileQuote> = [
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5400000, contractType: "P", iv: 0.18, delta: -0.2, moneyness: 0.98 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5200000, contractType: "P", iv: 0.9, delta: -1.2, moneyness: 0.92 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5600000, contractType: "C", iv: 0.15, delta: 0.3, moneyness: 1.02 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.13, delta: 0.2, moneyness: 1.01 },
    ];
  ...
  it("interpolates exactly when a point sits on −0.25 / +0.25 (degenerate bracket)", () => {
    const exact: ReadonlyArray<SmileQuote> = [
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5400000, contractType: "P", iv: 0.21, delta: -0.25, moneyness: 0.98 },
      { underlying: "SPX", root: "SPXW" as const, expiration: "2026-07-17", strike: 5550000, contractType: "C", iv: 0.12, delta: 0.25, moneyness: 1.01 },
    ];
