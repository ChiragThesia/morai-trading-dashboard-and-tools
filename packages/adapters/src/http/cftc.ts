...
const CftcRowSchema = z.object({
  ...
  asset_mgr_positions_long_all: z.coerce.number(),
  asset_mgr_positions_short_all: z.coerce.number(),
  lev_money_positions_long_all: z.coerce.number(),
  lev_money_positions_short_all: z.coerce.number(),
  other_rept_positions_long_all: z.coerce.number(),
  other_rept_positions_short_all: z.coerce.number(),
...
function mapRowToReport(row: CftcRow): CotReport {
  return {
    ...
    assetMgrLong: row.asset_mgr_positions_long_all,
    assetMgrShort: row.asset_mgr_positions_short_all,
    levMoneyLong: row.lev_money_positions_long_all,
    levMoneyShort: row.lev_money_positions_short_all,
    otherReptLong: row.other_rept_positions_long_all,
    otherReptShort: row.other_rept_positions_short_all,
