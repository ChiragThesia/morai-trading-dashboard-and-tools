 ...
 *
 * 24/7 compute: no RTH/holiday gate (T-08-11 retired) — the GEX write upserts by cycleTime,
 *   so off-hours re-runs on a frozen cohort are idempotent. The journal gate lives solely in
 *   snapshot-calendars.
