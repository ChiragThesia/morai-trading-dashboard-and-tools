...
MORAI's live surfaces on a TradingView chart. Two files:

| File | What |
|---|---|
| `morai-board.pine` | The chart study — regime, vol term structure, entry gate, macro, positioning, gamma levels |
