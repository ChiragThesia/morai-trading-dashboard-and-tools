...
- [x] 14-03-PLAN.md — FRED series (no-fallback) + CBOE VVIX adapters + Postgres repo + memory twin + contract suite (MAC-01)
- [x] 14-04-PLAN.md — Core use-cases: fetchMacroSeries (allSettled, fail-loud) + getMacro (group/window) (MAC-01/02)

**Wave 3** *(blocked on Wave 2)*

- [x] 14-05-PLAN.md — Worker: fetch-rates handler extend + 2× daily cron (D-06) + composition wiring (MAC-01)
- [x] 14-06-PLAN.md — Server: GET /api/analytics/macro + get_macro MCP tool + composition wiring (MAC-02, MCP-02)
...
- [x] 15-05-PLAN.md — AUTH-05: amber pre-expiry banner (extends AuthExpiredBanner, both apps)
