...
- [ ] 17.1-04-PLAN.md — OVW-05 date picker (native input + ‹›/Today) + `daysForward` wiring + TOS color application on the hero (OVW-05, OVW-04)
...
| 17.1. Overview Payoff — TOS Graph + Interactivity | v1.2 | 2/5 | In Progress|  |
