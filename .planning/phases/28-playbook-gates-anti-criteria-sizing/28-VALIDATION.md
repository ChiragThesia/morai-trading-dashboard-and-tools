...
| 28-06-* | 06 | 5 | PLAY-01/03/04 | silent-blind UI | Board gate chip incl. loud GATE BLIND state; Analyzer sizing count render; event-bucket label distinct | RTL | `bun run test -- apps/web/src/components/RegimeBoard.test.tsx apps/web/src/components/picker/EntryExitPlan.test.tsx apps/web/src/components/picker/CandidateCard.test.tsx` | ✅ extend | ⬜ pending |
